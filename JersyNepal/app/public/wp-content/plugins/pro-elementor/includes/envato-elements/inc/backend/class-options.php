...
class Options extends Base {
	...
	public function print_admin_env_vars() {
		$admin_options = array(
			...
			'dismissed_banners'   => Options::get_instance()->get( 'dismissed_banners', ['templateKitBanner' => true] ),
			'project_name'        => Options::get_instance()->get( 'project_name', 'localhost' ),
			'start_page'          => Options::get_instance()->get( 'start_page', 'premium-kits' ),
			'settings_page'       => admin_url( 'admin.php?page=pro-elementor-settings' ),
		);
		?>
		<script>
